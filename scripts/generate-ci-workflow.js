...
function generateWorkflow() {
  ...
  // Read template file
  const templatePath = path.join(__dirname, '../.github/workflow-templates/android-build-template.yml');
  ...
  // Replace template trigger with actual triggers
  content = content.replace(/# TEMPLATE FILE - DO NOT RUN[\s\S]*?workflow_dispatch: # Manual trigger only for template testing/g,
